...
import {
  StyleSheet, Button, Text, View, TouchableOpacity, ScrollView, Image, ActivityIndicator, TextInput, Alert, Pressable, ToastAndroid,
  StatusBar
} from 'react-native';
           ...
           style={[styles.centerElement, {height: 80, width: 80, backgroundColor: '#eeeeee',borderRadius:20}]}/> */}
            ...
            <View style={{ flexGrow: 1, flexShrink: 1, alignSelf: 'center' }}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{
                  borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#cccccc', paddingHorizontal: 7,
                  paddingTop: 3, color: '#bbbbbb', fontSize: 13
                }}>{item.qty}</Text>
