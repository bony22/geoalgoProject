  ...
  list1 = () => {
    return this.state.VariusItems1.map((element, index) => {
        return (
            ...
            <Card style={{flexDirection:'row',borderRadius:9,elevation:5,width:width-40,backgroundColor:'seashell'}}>
                    ...
                    <View style={{width:'80%',flexDirection:'row'}}>
                        <View style={{justifyContent:'center',marginHorizontal:2,width:'65%' }}
                         onTouchEnd={()=>{
                            ...
                            <Text style={{color:'#006565',fontSize:16,letterSpacing:1}}>{element.productname}</Text> 
                            <Text numberOfLines={1} style={{color:'#006565',fontSize:12, letterSpacing:1}}>{element.brand}</Text> 
                        ...
                        <View style={{justifyContent:'center',width:'40%',alignItems:'center',}}
                         >
                                ...
                                borderRadius:7,backgroundColor:'#F3C714',elevation:5}}>
