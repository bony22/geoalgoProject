...
export default class ProductFilter extends Component {
    ...
    render() {
        return (
          ...
          style={{ height: 65, elevation: 10, width: '100%', alignItems: 'center',
      ...
      <View style={{ height: 65, width: '70%', alignItems: 'center',
       justifyContent: 'space-between', flexDirection: 'row', backgroundColor: 'white',padding:15 }}>
            ...
            style={{height:40,width:'30%',alignItems:'center',justifyContent:'center',
